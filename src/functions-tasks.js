...
function getArgumentsCount(funcs) {
  if (!Array.isArray(funcs)) {
    throw new TypeError('not a dunction');
  }
...
function memoize(func) {
  ...
  return function memo() {
    if (cachedResult === undefined) {
      cachedResult = func(); // Call the original function and store the result
    }
    return cachedResult; // Return the cached result on subsequent calls
  };
}
